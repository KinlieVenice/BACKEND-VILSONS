...
async function getRolePermissionData() {
  const admin = [
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.ADMIN),
    ...
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.ADMIN),
      permissionId: await idFinders.permissionIdFinder(PERMISSIONS_LIST.VIEW_SINGLE_TRUCK),
      approval: false,
    },
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.ADMIN),
    ...
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.ADMIN),
      permissionId: await idFinders.permissionIdFinder(PERMISSIONS_LIST.EDIT_TRUCK_OWNER),
      approval: false,
    },
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.ADMIN),
  ...
  const employee = [
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.EMPLOYEE),
      permissionId: await idFinders.permissionIdFinder(
        PERMISSIONS_LIST.EDIT_PROFILE_DETAILS
      ),
      approval: false,
  ...
  const contractor = [
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.CONTRACTOR),
      permissionId: await idFinders.permissionIdFinder(
        PERMISSIONS_LIST.EDIT_PROFILE_DETAILS
      ),
      approval: false,
  ...
  const customer = [
    {
      roleId: await idFinders.roleIdFinder(ROLES_LIST.CUSTOMER),
      permissionId: await idFinders.permissionIdFinder(
        PERMISSIONS_LIST.EDIT_PROFILE_DETAILS
      ),
      approval: false,
