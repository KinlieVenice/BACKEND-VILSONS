const { VIEW_LABORS, CREATE_EQUIPMENT, VIEW_MATERIALS, CREATE_OVERHEAD, VIEW_ACTIVITY_LOGS, VIEW_APPROVAL_LOGS, VIEW_REVENUE_PROFIT, CREATE_JOB_ORDER, CREATE_OTHER_INCOME, CREATE_TRANSACTION, CREATE_TRUCK, CREATE_USER, VIEW_CONTRACTORS, VIEW_CUSTOMERS, VIEW_EMPLOYEES, CREATE_BRANCH, VIEW_BRANCHES, EDIT_BRANCH, DELETE_BRANCH } = require("./PERMISSIONS_LIST");
...
const PERMISSIONS_LIST = {
  ...
  // 
  ADMIN_DASHBOARD_REVENUE: "admin_dashboard_revenue",
  ADMIN_DASHBOARD_EXPENSES: "admin_dashboard_expenses",
  ADMIN_DASHBOARD_PROFIT: "admin_dashboard_profit",
  ADMIN_DASHBOARD_CUSTOMER_BALANCE: "admin_dashboard_customer_balance",
  ADMIN_DASHBOARD_JOB_ORDERS: "admin_dashboard_job_orders",
  ...
  CUSTOMER_DASHBOARD_JOB_ORDERS: "customer_dashboard_job_orders",
  CUSTOMER_DASHBOARD_BALANCE: "customer_dashboard_balance",

  VIEW_CUSTOMER_OWN_JOB_ORDERS: "view_customer_own_job_orders",
  VIEW_CUSTOMER_OWN_TRANSACTIONS: "view_customer_own_transactions",

  CONTRACTOR_DASHBOARD_JOB_ORDERS: "contractor_dashboard_job_orders",
  CONTRACTOR_DASHBOARD_BALANCE: "contractor_dashboard_balance",
