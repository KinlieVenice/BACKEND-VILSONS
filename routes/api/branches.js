...
.get(verifyPermission(PERMISSIONS_LIST.VIEW_BRANCHES), branchController.getAllBranches);
...
.get(verifyPermission(PERMISSIONS_LIST.VIEW_BRANCHES), branchController.getBranch);
